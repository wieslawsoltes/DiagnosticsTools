...
public sealed class IndentLevelToThicknessConverter : IValueConverter
{
...
public sealed class BooleanToAngleConverter : IValueConverter
{
...
public sealed class TreeViewItemIndentConverter : IMultiValueConverter
{
