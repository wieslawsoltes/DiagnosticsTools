...
namespace Avalonia.Diagnostics.PropertyEditing
{
    ...
    public sealed class ChangeSourceInfo
    {
    ...
    public sealed class ChangeSourceCommandInfo
    {
        [JsonPropertyName("id")]
    ...
    public sealed class ChangeDocumentInfo
    {
    ...
    public sealed class ChangeContextInfo
    {
    ...
    public sealed class ChangeTarget
    {
    ...
    public sealed class IndentationPolicyPayload
    {
    ...
    public sealed class ChangeOperationGuard
    {
