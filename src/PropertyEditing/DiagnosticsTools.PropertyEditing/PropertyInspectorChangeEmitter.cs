...
{
    public sealed class PropertyInspectorChangeEmitter
    {
        ...
        public XamlMutationDispatcher? MutationDispatcher => _dispatcher as XamlMutationDispatcher;
        ...
        public event EventHandler<ExternalDocumentChangedEventArgs>? ExternalDocumentChanged;
    ...
    public static class ChangeOperationTypes
    {
